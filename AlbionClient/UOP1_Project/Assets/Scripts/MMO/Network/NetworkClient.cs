...
public class NetworkClient : IDisposable
{
    ...
    private void HandleDisconnect()
    {
        ...
        // Instance 를 직접 호출하면 백그라운드 스레드에서 GameObject 생성 시도 → 크래시.
        // 플레이 종료 시점이면 dispatcher 가 이미 파괴돼 있으므로 TryEnqueue 가 알아서 no-op.
        MainThreadDispatcher.TryEnqueue(() => OnDisconnected?.Invoke());
